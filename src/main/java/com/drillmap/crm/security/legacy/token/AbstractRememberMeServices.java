...
public abstract class AbstractRememberMeServices implements RememberMeServices, InitializingBean, LogoutHandler {
    ...
    @Value("${orgid.session.key}")
    public String ORGID_SESSION_KEY;
    ...
    public String[] extractAndDecodeCookie(HttpServletRequest request, HttpServletResponse response) {
        ...
        return decodeCookie(rememberMeCookie);
    }
    ...
    public final Authentication autoLogin(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            if (cookieTokens == null) {
                //unable to decode cookie or cookie is not set
                return null;
            }
    ...
    //shane
    //TODO this should return exactly two elements ever
    public String[] splitUserNameOrgId(String userOrg) {
        return StringUtils.split(userOrg, "/");
    }

    public String combineUserNameOrgId(HttpServletRequest request, String username) {
        HttpSession session = request.getSession(false);
        String orgId = (String) session.getAttribute(ORGID_SESSION_KEY);
        if (StringUtils.hasText(orgId)) {
            return username + "/" + orgId;
        } else {
            logger.warn("OrgId is null. Unable to create username orgid key.");
            return username;
        }
    }
